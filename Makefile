...
# Source files
SOURCES = Main.cpp OrderTake.cpp PizzaCookGame.cpp PizzaCutGame.cpp Order.cpp TicketRack.cpp TextureManager.cpp Customer.cpp AddToppingsGame.cpp Pizza.cpp Topping.cpp CookingStage.cpp PizzaCook.cpp Random.cpp
